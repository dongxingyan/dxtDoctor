...
let commonConfig = {
  ...
  module: {
    loaders: [
      // { test: /\.(jpg|gif|png|woff|woff2|svg|eot|ttf)(\?v=.*)?$/, loader: 'url-loader?limit=10' },
      { test: /\.(jpg|gif|png|woff|woff2|svg|eot|ttf)(\?.*)?$/, loader: 'url-loader?limit=10' },
...
if (TARGET === 'start') {
  configObj = merge(commonConfig, {
    devServer: {
      ...
      proxy: {
        '/cloudp/**': {
          target: 'https://api-dxt-sit.cloudp.cc',
